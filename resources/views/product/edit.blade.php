            ...
            <form action="{{route('product.update',["product"=>$product])}}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" id="description"
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 h-32">{{$product->description}}</textarea>
                </div>
                <div class="mb-6">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <button type="submit"
                            class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition duration-150">
                        Update Product
                    </button>
                </div>
            </form>
